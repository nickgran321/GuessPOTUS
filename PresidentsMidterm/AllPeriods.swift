...
struct AllPeriods: View {
    ...
    func presidentTapped(_ number: Int) {
        if number == correctAnswer {
            ...
            score += 30
            UserDefaults.standard.set(self.score, forKey: "ScoreAllPeriods")
...
struct AllPeriods_Previews: PreviewProvider {
